...
export const EdgeJobFetchedSchema = {
    properties: {
        dag_id: {
            type: 'string',
            title: 'Dag ID',
...
export const EdgeWorkerStateSchema = {
    type: 'string',
...
export const JobCollectionResponseSchema = {
    properties: {
        jobs: {
            items: {
...
export const PushLogsBodySchema = {
    properties: {
        log_chunk_time: {
            type: 'string',
            format: 'date-time',
...
export const TaskInstanceSchema = {
    properties: {
        id: {
            type: 'string',
            format: 'uuid',
...
export const TaskInstanceStateSchema = {
    type: 'string',
...
export const WorkerCollectionResponseSchema = {
    properties: {
        workers: {
            items: {
...
export const WorkerQueueUpdateBodySchema = {
    properties: {
        new_queues: {
            anyOf: [
                {
...
export const WorkerQueuesBodySchema = {
    properties: {
        queues: {
            anyOf: [
                {
...
export const WorkerRegistrationReturnSchema = {
    properties: {
        last_update: {
            type: 'string',
            format: 'date-time',
...
export const WorkerSetStateReturnSchema = {
    properties: {
        state: {
            '$ref': '#/components/schemas/EdgeWorkerState',
...
export const WorkerStateBodySchema = {
    properties: {
        queues: {
            anyOf: [
                {
